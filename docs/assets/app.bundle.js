...
var UI = function () {
	...
	_createClass(UI, [{
		...
		key: 'showAlert',
		value: function showAlert(message, classes) {
			var _this = this;
		...
		value: function showResults() {
			...
			var congratulationMessage = document.createElement('h3');
		...
		key: 'countAnswers',
		value: function countAnswers(currentIndex, answer) {
			var currentQuestion = [];
			currentQuestion.push(answer);
			this.questionsReceived.filter(function (q, index) {
